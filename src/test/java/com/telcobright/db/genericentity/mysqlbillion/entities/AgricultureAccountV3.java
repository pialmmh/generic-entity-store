...
/**
 * MySQL Entity: AgricultureAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureAccountV3 implements Serializable {
    ...
    public AgricultureAccountV3() {}

    public AgricultureAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
