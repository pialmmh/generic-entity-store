...
/**
 * MySQL Entity: AgricultureAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureAnalyticsV3 implements Serializable {
    ...
    public AgricultureAnalyticsV3() {}

    public AgricultureAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
