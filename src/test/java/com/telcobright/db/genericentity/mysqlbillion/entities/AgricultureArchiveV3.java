...
/**
 * MySQL Entity: AgricultureArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureArchiveV3 implements Serializable {
    ...
    public AgricultureArchiveV3() {}

    public AgricultureArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
