...
/**
 * MySQL Entity: AgricultureAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureAuditV3 implements Serializable {
    ...
    public AgricultureAuditV3() {}

    public AgricultureAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
