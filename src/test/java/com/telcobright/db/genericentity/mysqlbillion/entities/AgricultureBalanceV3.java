...
/**
 * MySQL Entity: AgricultureBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureBalanceV3 implements Serializable {
    ...
    public AgricultureBalanceV3() {}

    public AgricultureBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
