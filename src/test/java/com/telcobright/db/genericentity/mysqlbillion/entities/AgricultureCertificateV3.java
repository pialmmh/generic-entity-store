...
/**
 * MySQL Entity: AgricultureCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureCertificateV3 implements Serializable {
    ...
    public AgricultureCertificateV3() {}

    public AgricultureCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
