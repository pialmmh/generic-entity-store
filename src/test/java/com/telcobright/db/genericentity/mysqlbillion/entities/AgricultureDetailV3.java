...
/**
 * MySQL Entity: AgricultureDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureDetailV3 implements Serializable {
    ...
    public AgricultureDetailV3() {}

    public AgricultureDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
