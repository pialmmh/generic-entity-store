...
/**
 * MySQL Entity: AgricultureDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureDocumentV3 implements Serializable {
    ...
    public AgricultureDocumentV3() {}

    public AgricultureDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
