...
/**
 * MySQL Entity: AgricultureEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureEntryV3 implements Serializable {
    ...
    public AgricultureEntryV3() {}

    public AgricultureEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
