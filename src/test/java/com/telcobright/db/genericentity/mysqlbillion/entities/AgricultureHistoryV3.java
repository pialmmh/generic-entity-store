...
/**
 * MySQL Entity: AgricultureHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureHistoryV3 implements Serializable {
    ...
    public AgricultureHistoryV3() {}

    public AgricultureHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
