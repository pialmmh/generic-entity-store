...
/**
 * MySQL Entity: AgricultureInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureInvoiceV3 implements Serializable {
    ...
    public AgricultureInvoiceV3() {}

    public AgricultureInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
