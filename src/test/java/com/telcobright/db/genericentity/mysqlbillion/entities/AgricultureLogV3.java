...
/**
 * MySQL Entity: AgricultureLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureLogV3 implements Serializable {
    ...
    public AgricultureLogV3() {}

    public AgricultureLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
