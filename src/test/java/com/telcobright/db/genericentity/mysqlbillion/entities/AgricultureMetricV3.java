...
/**
 * MySQL Entity: AgricultureMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureMetricV3 implements Serializable {
    ...
    public AgricultureMetricV3() {}

    public AgricultureMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
