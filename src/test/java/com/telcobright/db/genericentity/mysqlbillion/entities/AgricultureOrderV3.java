...
/**
 * MySQL Entity: AgricultureOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureOrderV3 implements Serializable {
    ...
    public AgricultureOrderV3() {}

    public AgricultureOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
