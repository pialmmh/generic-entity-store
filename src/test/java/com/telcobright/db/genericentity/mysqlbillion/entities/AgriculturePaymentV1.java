...
/**
 * MySQL Entity: AgriculturePaymentV1
 * Variant 1 with specific MySQL data type combinations
 */
public class AgriculturePaymentV1 implements Serializable {
    ...
    public AgriculturePaymentV1() {}

    public AgriculturePaymentV1(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
