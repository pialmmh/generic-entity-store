...
/**
 * MySQL Entity: AgriculturePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgriculturePaymentV3 implements Serializable {
    ...
    public AgriculturePaymentV3() {}

    public AgriculturePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
