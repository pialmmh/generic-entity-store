...
/**
 * MySQL Entity: AgricultureProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureProfileV3 implements Serializable {
    ...
    public AgricultureProfileV3() {}

    public AgricultureProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
