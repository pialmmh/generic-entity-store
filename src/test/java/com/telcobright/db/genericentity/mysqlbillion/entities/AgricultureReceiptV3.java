...
/**
 * MySQL Entity: AgricultureReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureReceiptV3 implements Serializable {
    ...
    public AgricultureReceiptV3() {}

    public AgricultureReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
