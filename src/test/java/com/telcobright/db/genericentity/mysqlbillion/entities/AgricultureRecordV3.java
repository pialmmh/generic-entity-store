...
/**
 * MySQL Entity: AgricultureRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureRecordV3 implements Serializable {
    ...
    public AgricultureRecordV3() {}

    public AgricultureRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
