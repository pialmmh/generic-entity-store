...
/**
 * MySQL Entity: AgricultureStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureStatementV3 implements Serializable {
    ...
    public AgricultureStatementV3() {}

    public AgricultureStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
