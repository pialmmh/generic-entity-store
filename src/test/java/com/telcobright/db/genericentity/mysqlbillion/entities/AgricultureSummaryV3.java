...
/**
 * MySQL Entity: AgricultureSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureSummaryV3 implements Serializable {
    ...
    public AgricultureSummaryV3() {}

    public AgricultureSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
