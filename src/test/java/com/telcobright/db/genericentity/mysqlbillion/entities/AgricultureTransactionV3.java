...
/**
 * MySQL Entity: AgricultureTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class AgricultureTransactionV3 implements Serializable {
    ...
    public AgricultureTransactionV3() {}

    public AgricultureTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
