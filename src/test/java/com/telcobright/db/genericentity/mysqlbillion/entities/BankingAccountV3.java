...
/**
 * MySQL Entity: BankingAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingAccountV3 implements Serializable {
    ...
    public BankingAccountV3() {}

    public BankingAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
