...
/**
 * MySQL Entity: BankingAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingAnalyticsV3 implements Serializable {
    private static final long serialVersionUID = 629L;
    ...
    public BankingAnalyticsV3() {}

    public BankingAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
