...
/**
 * MySQL Entity: BankingArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingArchiveV3 implements Serializable {
    ...
    public BankingArchiveV3() {}

    public BankingArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
