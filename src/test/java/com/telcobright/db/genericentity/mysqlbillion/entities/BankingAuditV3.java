...
/**
 * MySQL Entity: BankingAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingAuditV3 implements Serializable {
    ...
    public BankingAuditV3() {}

    public BankingAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
