...
/**
 * MySQL Entity: BankingBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingBalanceV3 implements Serializable {
    private static final long serialVersionUID = 659L;
    ...
    public BankingBalanceV3() {}

    public BankingBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
