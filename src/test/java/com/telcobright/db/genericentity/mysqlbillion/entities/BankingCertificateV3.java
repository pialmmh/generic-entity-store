...
/**
 * MySQL Entity: BankingCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingCertificateV3 implements Serializable {
    ...
    public BankingCertificateV3() {}

    public BankingCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
