...
/**
 * MySQL Entity: BankingDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingDetailV3 implements Serializable {
    ...
    public BankingDetailV3() {}

    public BankingDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
