...
/**
 * MySQL Entity: BankingDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingDocumentV3 implements Serializable {
    ...
    public BankingDocumentV3() {}

    public BankingDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
