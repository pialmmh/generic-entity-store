...
/**
 * MySQL Entity: BankingEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingEntryV3 implements Serializable {
    ...
    public BankingEntryV3() {}

    public BankingEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
