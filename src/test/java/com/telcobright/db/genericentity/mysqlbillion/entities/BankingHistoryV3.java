...
/**
 * MySQL Entity: BankingHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingHistoryV3 implements Serializable {
    ...
    public BankingHistoryV3() {}

    public BankingHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
