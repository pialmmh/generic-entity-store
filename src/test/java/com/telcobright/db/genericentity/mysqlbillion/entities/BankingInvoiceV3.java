...
/**
 * MySQL Entity: BankingInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingInvoiceV3 implements Serializable {
    ...
    public BankingInvoiceV3() {}

    public BankingInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
