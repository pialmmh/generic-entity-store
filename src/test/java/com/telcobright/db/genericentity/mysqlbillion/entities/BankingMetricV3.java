...
/**
 * MySQL Entity: BankingMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingMetricV3 implements Serializable {
    ...
    public BankingMetricV3() {}

    public BankingMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
