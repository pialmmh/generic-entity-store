...
/**
 * MySQL Entity: BankingOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingOrderV3 implements Serializable {
    private static final long serialVersionUID = 647L;
    ...
    public BankingOrderV3() {}

    public BankingOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
