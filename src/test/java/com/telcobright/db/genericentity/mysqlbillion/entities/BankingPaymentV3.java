...
/**
 * MySQL Entity: BankingPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingPaymentV3 implements Serializable {
    ...
    public BankingPaymentV3() {}

    public BankingPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
