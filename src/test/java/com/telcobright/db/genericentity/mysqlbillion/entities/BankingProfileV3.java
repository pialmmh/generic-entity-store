...
/**
 * MySQL Entity: BankingProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingProfileV3 implements Serializable {
    ...
    public BankingProfileV3() {}

    public BankingProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
