...
/**
 * MySQL Entity: BankingRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingRecordV3 implements Serializable {
    ...
    public BankingRecordV3() {}

    public BankingRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
