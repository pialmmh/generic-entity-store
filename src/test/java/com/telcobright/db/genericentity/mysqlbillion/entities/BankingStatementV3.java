...
/**
 * MySQL Entity: BankingStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingStatementV3 implements Serializable {
    private static final long serialVersionUID = 656L;
    ...
    public BankingStatementV3() {}

    public BankingStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
