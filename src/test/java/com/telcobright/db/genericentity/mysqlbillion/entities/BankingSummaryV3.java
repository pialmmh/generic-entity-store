...
/**
 * MySQL Entity: BankingSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingSummaryV3 implements Serializable {
    ...
    public BankingSummaryV3() {}

    public BankingSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
