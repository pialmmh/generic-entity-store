...
/**
 * MySQL Entity: BankingTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class BankingTransactionV3 implements Serializable {
    private static final long serialVersionUID = 596L;
    ...
    public BankingTransactionV3() {}

    public BankingTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
