...
/**
 * MySQL Entity: EcommerceAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceAnalyticsV3 implements Serializable {
    ...
    public EcommerceAnalyticsV3() {}

    public EcommerceAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
