...
/**
 * MySQL Entity: EcommerceArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceArchiveV3 implements Serializable {
    private static final long serialVersionUID = 683L;
    ...
    public EcommerceArchiveV3() {}

    public EcommerceArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
