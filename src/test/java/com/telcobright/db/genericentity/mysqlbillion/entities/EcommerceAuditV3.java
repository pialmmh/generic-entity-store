...
/**
 * MySQL Entity: EcommerceAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceAuditV3 implements Serializable {
    ...
    public EcommerceAuditV3() {}

    public EcommerceAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
