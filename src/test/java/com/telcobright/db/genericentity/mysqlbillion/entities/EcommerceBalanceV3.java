...
/**
 * MySQL Entity: EcommerceBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceBalanceV3 implements Serializable {
    ...
    public EcommerceBalanceV3() {}

    public EcommerceBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
