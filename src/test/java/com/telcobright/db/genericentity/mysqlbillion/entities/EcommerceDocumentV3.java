...
/**
 * MySQL Entity: EcommerceDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceDocumentV3 implements Serializable {
    ...
    public EcommerceDocumentV3() {}

    public EcommerceDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
