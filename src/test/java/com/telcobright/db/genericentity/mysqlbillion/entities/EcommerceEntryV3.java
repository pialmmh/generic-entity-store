...
/**
 * MySQL Entity: EcommerceEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceEntryV3 implements Serializable {
    ...
    public EcommerceEntryV3() {}

    public EcommerceEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
