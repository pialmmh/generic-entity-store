...
/**
 * MySQL Entity: EcommerceHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceHistoryV3 implements Serializable {
    ...
    public EcommerceHistoryV3() {}

    public EcommerceHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
