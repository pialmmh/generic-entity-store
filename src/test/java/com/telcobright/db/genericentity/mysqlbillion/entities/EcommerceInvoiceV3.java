...
/**
 * MySQL Entity: EcommerceInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceInvoiceV3 implements Serializable {
    ...
    public EcommerceInvoiceV3() {}

    public EcommerceInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
