...
/**
 * MySQL Entity: EcommerceLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceLogV3 implements Serializable {
    private static final long serialVersionUID = 671L;
    ...
    public EcommerceLogV3() {}

    public EcommerceLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
