...
/**
 * MySQL Entity: EcommerceMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceMetricV3 implements Serializable {
    private static final long serialVersionUID = 692L;
    ...
    public EcommerceMetricV3() {}

    public EcommerceMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
