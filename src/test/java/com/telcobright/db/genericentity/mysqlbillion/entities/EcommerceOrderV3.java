...
/**
 * MySQL Entity: EcommerceOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceOrderV3 implements Serializable {
    ...
    public EcommerceOrderV3() {}

    public EcommerceOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
