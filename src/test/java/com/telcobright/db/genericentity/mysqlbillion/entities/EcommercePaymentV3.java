...
/**
 * MySQL Entity: EcommercePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommercePaymentV3 implements Serializable {
    private static final long serialVersionUID = 716L;
    ...
    public EcommercePaymentV3() {}

    public EcommercePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
