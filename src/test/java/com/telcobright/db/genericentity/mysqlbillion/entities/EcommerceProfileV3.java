...
/**
 * MySQL Entity: EcommerceProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceProfileV3 implements Serializable {
    private static final long serialVersionUID = 698L;
    ...
    public EcommerceProfileV3() {}

    public EcommerceProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
