...
/**
 * MySQL Entity: EcommerceReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceReceiptV3 implements Serializable {
    private static final long serialVersionUID = 719L;
    ...
    public EcommerceReceiptV3() {}

    public EcommerceReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
