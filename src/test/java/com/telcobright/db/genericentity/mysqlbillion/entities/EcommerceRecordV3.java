...
/**
 * MySQL Entity: EcommerceRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceRecordV3 implements Serializable {
    ...
    public EcommerceRecordV3() {}

    public EcommerceRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
