...
/**
 * MySQL Entity: EcommerceReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceReportV3 implements Serializable {
    private static final long serialVersionUID = 689L;
    ...
    public EcommerceReportV3() {}

    public EcommerceReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
