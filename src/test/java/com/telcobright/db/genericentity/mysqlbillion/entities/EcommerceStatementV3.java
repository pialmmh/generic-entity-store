...
/**
 * MySQL Entity: EcommerceStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceStatementV3 implements Serializable {
    ...
    public EcommerceStatementV3() {}

    public EcommerceStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
