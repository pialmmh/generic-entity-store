...
/**
 * MySQL Entity: EcommerceSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceSummaryV3 implements Serializable {
    private static final long serialVersionUID = 677L;
    ...
    public EcommerceSummaryV3() {}

    public EcommerceSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
