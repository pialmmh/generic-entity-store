...
/**
 * MySQL Entity: EcommerceTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EcommerceTransactionV3 implements Serializable {
    private static final long serialVersionUID = 662L;
    ...
    public EcommerceTransactionV3() {}

    public EcommerceTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
