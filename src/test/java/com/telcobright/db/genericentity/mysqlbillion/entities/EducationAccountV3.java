...
/**
 * MySQL Entity: EducationAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationAccountV3 implements Serializable {
    ...
    public EducationAccountV3() {}

    public EducationAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
