...
/**
 * MySQL Entity: EducationAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationAnalyticsV3 implements Serializable {
    ...
    public EducationAnalyticsV3() {}

    public EducationAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
