...
/**
 * MySQL Entity: EducationArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationArchiveV3 implements Serializable {
    ...
    public EducationArchiveV3() {}

    public EducationArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
