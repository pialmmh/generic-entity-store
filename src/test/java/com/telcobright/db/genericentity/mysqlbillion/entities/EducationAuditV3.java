...
/**
 * MySQL Entity: EducationAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationAuditV3 implements Serializable {
    ...
    public EducationAuditV3() {}

    public EducationAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
