...
/**
 * MySQL Entity: EducationBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationBalanceV3 implements Serializable {
    ...
    public EducationBalanceV3() {}

    public EducationBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
