...
/**
 * MySQL Entity: EducationCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationCertificateV3 implements Serializable {
    ...
    public EducationCertificateV3() {}

    public EducationCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
