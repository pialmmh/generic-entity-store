...
/**
 * MySQL Entity: EducationDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationDetailV3 implements Serializable {
    ...
    public EducationDetailV3() {}

    public EducationDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
