...
/**
 * MySQL Entity: EducationDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationDocumentV3 implements Serializable {
    ...
    public EducationDocumentV3() {}

    public EducationDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
