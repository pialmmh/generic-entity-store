...
/**
 * MySQL Entity: EducationEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationEntryV3 implements Serializable {
    ...
    public EducationEntryV3() {}

    public EducationEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
