...
/**
 * MySQL Entity: EducationHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationHistoryV3 implements Serializable {
    ...
    public EducationHistoryV3() {}

    public EducationHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
