...
/**
 * MySQL Entity: EducationInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationInvoiceV3 implements Serializable {
    ...
    public EducationInvoiceV3() {}

    public EducationInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
