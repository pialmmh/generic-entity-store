...
/**
 * MySQL Entity: EducationLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationLogV3 implements Serializable {
    ...
    public EducationLogV3() {}

    public EducationLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
