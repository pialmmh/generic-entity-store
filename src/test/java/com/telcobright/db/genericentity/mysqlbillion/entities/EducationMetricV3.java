...
/**
 * MySQL Entity: EducationMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationMetricV3 implements Serializable {
    ...
    public EducationMetricV3() {}

    public EducationMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
