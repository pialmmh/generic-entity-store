...
/**
 * MySQL Entity: EducationOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationOrderV3 implements Serializable {
    ...
    public EducationOrderV3() {}

    public EducationOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
