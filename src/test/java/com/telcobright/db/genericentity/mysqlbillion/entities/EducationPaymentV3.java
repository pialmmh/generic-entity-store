...
/**
 * MySQL Entity: EducationPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationPaymentV3 implements Serializable {
    ...
    public EducationPaymentV3() {}

    public EducationPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
