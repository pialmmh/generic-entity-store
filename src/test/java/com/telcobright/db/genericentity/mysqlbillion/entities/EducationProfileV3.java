...
/**
 * MySQL Entity: EducationProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationProfileV3 implements Serializable {
    private static final long serialVersionUID = 368L;
    ...
    public EducationProfileV3() {}

    public EducationProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
