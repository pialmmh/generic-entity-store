...
/**
 * MySQL Entity: EducationReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationReceiptV3 implements Serializable {
    ...
    public EducationReceiptV3() {}

    public EducationReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
