...
/**
 * MySQL Entity: EducationRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationRecordV3 implements Serializable {
    ...
    public EducationRecordV3() {}

    public EducationRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
