...
/**
 * MySQL Entity: EducationReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationReportV3 implements Serializable {
    private static final long serialVersionUID = 359L;
    ...
    public EducationReportV3() {}

    public EducationReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
