...
/**
 * MySQL Entity: EducationStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationStatementV3 implements Serializable {
    ...
    public EducationStatementV3() {}

    public EducationStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
