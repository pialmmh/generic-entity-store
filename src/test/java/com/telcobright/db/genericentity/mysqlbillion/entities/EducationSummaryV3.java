...
/**
 * MySQL Entity: EducationSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationSummaryV3 implements Serializable {
    ...
    public EducationSummaryV3() {}

    public EducationSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
