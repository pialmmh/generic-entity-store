...
/**
 * MySQL Entity: EducationTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EducationTransactionV3 implements Serializable {
    ...
    public EducationTransactionV3() {}

    public EducationTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
