...
/**
 * MySQL Entity: EnergyAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyAccountV3 implements Serializable {
    ...
    public EnergyAccountV3() {}

    public EnergyAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
