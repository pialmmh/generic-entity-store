...
/**
 * MySQL Entity: EnergyAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyAnalyticsV3 implements Serializable {
    ...
    public EnergyAnalyticsV3() {}

    public EnergyAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
