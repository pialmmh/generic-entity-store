...
/**
 * MySQL Entity: EnergyArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyArchiveV3 implements Serializable {
    ...
    public EnergyArchiveV3() {}

    public EnergyArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
