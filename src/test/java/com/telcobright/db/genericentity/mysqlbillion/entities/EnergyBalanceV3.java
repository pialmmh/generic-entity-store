...
/**
 * MySQL Entity: EnergyBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyBalanceV3 implements Serializable {
    ...
    public EnergyBalanceV3() {}

    public EnergyBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
