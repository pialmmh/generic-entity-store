...
/**
 * MySQL Entity: EnergyCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyCertificateV3 implements Serializable {
    ...
    public EnergyCertificateV3() {}

    public EnergyCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
