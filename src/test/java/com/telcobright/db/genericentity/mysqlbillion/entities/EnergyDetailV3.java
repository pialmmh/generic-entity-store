...
/**
 * MySQL Entity: EnergyDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyDetailV3 implements Serializable {
    ...
    public EnergyDetailV3() {}

    public EnergyDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
