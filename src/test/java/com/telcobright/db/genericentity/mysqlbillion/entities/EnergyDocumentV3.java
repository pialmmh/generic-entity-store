...
/**
 * MySQL Entity: EnergyDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyDocumentV3 implements Serializable {
    ...
    public EnergyDocumentV3() {}

    public EnergyDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
