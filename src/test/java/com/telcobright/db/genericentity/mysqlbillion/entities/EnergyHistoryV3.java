...
/**
 * MySQL Entity: EnergyHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyHistoryV3 implements Serializable {
    ...
    public EnergyHistoryV3() {}

    public EnergyHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
