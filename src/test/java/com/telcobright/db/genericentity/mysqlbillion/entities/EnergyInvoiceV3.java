...
/**
 * MySQL Entity: EnergyInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyInvoiceV3 implements Serializable {
    ...
    public EnergyInvoiceV3() {}

    public EnergyInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
