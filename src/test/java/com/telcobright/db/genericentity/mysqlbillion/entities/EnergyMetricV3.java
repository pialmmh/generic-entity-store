...
/**
 * MySQL Entity: EnergyMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyMetricV3 implements Serializable {
    ...
    public EnergyMetricV3() {}

    public EnergyMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
