...
/**
 * MySQL Entity: EnergyPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyPaymentV3 implements Serializable {
    ...
    public EnergyPaymentV3() {}

    public EnergyPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
