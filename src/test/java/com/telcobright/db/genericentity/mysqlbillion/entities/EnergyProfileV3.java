...
/**
 * MySQL Entity: EnergyProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyProfileV3 implements Serializable {
    ...
    public EnergyProfileV3() {}

    public EnergyProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
