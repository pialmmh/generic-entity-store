...
/**
 * MySQL Entity: EnergyReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyReceiptV3 implements Serializable {
    ...
    public EnergyReceiptV3() {}

    public EnergyReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
