...
/**
 * MySQL Entity: EnergyRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyRecordV3 implements Serializable {
    ...
    public EnergyRecordV3() {}

    public EnergyRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
