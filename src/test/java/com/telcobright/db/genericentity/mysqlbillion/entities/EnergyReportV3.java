...
/**
 * MySQL Entity: EnergyReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyReportV3 implements Serializable {
    ...
    public EnergyReportV3() {}

    public EnergyReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
