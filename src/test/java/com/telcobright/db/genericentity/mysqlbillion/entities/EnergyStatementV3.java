...
/**
 * MySQL Entity: EnergyStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyStatementV3 implements Serializable {
    ...
    public EnergyStatementV3() {}

    public EnergyStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
