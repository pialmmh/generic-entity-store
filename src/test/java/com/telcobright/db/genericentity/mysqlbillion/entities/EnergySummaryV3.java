...
/**
 * MySQL Entity: EnergySummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergySummaryV3 implements Serializable {
    ...
    public EnergySummaryV3() {}

    public EnergySummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
