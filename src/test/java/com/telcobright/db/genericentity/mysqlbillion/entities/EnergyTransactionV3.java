...
/**
 * MySQL Entity: EnergyTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class EnergyTransactionV3 implements Serializable {
    ...
    public EnergyTransactionV3() {}

    public EnergyTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
