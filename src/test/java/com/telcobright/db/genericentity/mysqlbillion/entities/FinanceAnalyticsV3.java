...
/**
 * MySQL Entity: FinanceAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceAnalyticsV3 implements Serializable {
    ...
    public FinanceAnalyticsV3() {}

    public FinanceAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
