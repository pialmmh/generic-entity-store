...
/**
 * MySQL Entity: FinanceAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceAuditV3 implements Serializable {
    ...
    public FinanceAuditV3() {}

    public FinanceAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
