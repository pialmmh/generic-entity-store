...
/**
 * MySQL Entity: FinanceBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceBalanceV3 implements Serializable {
    ...
    public FinanceBalanceV3() {}

    public FinanceBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
