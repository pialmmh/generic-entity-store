...
/**
 * MySQL Entity: FinanceCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceCertificateV3 implements Serializable {
    ...
    public FinanceCertificateV3() {}

    public FinanceCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
