...
/**
 * MySQL Entity: FinanceDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceDetailV3 implements Serializable {
    ...
    public FinanceDetailV3() {}

    public FinanceDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
