...
/**
 * MySQL Entity: FinanceDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceDocumentV3 implements Serializable {
    ...
    public FinanceDocumentV3() {}

    public FinanceDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
