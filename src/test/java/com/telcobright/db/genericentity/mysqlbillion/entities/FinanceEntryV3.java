...
/**
 * MySQL Entity: FinanceEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceEntryV3 implements Serializable {
    ...
    public FinanceEntryV3() {}

    public FinanceEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
