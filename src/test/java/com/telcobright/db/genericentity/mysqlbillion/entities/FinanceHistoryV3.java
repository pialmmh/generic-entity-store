...
/**
 * MySQL Entity: FinanceHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceHistoryV3 implements Serializable {
    ...
    public FinanceHistoryV3() {}

    public FinanceHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
