...
/**
 * MySQL Entity: FinanceInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceInvoiceV3 implements Serializable {
    ...
    public FinanceInvoiceV3() {}

    public FinanceInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
