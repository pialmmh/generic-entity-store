...
/**
 * MySQL Entity: FinanceMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceMetricV3 implements Serializable {
    ...
    public FinanceMetricV3() {}

    public FinanceMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
