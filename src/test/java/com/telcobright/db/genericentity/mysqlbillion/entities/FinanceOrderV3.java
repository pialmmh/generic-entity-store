...
/**
 * MySQL Entity: FinanceOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceOrderV3 implements Serializable {
    ...
    public FinanceOrderV3() {}

    public FinanceOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
