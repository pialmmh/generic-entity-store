...
/**
 * MySQL Entity: FinancePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinancePaymentV3 implements Serializable {
    ...
    public FinancePaymentV3() {}

    public FinancePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
