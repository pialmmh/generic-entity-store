...
/**
 * MySQL Entity: FinanceProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceProfileV3 implements Serializable {
    ...
    public FinanceProfileV3() {}

    public FinanceProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
