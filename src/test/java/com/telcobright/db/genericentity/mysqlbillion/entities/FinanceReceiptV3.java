...
/**
 * MySQL Entity: FinanceReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceReceiptV3 implements Serializable {
    ...
    public FinanceReceiptV3() {}

    public FinanceReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
