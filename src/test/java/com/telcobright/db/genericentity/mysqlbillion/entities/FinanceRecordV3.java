...
/**
 * MySQL Entity: FinanceRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceRecordV3 implements Serializable {
    ...
    public FinanceRecordV3() {}

    public FinanceRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
