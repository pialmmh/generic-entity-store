...
/**
 * MySQL Entity: FinanceReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceReportV3 implements Serializable {
    ...
    public FinanceReportV3() {}

    public FinanceReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
