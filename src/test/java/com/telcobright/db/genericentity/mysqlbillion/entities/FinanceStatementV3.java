...
/**
 * MySQL Entity: FinanceStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceStatementV3 implements Serializable {
    ...
    public FinanceStatementV3() {}

    public FinanceStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
