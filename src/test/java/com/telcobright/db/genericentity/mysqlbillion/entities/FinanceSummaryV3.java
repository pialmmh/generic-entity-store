...
/**
 * MySQL Entity: FinanceSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceSummaryV3 implements Serializable {
    ...
    public FinanceSummaryV3() {}

    public FinanceSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
