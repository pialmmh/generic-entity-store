...
/**
 * MySQL Entity: FinanceTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class FinanceTransactionV3 implements Serializable {
    ...
    public FinanceTransactionV3() {}

    public FinanceTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
