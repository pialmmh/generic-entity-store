...
/**
 * MySQL Entity: GamingAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingAccountV3 implements Serializable {
    private static final long serialVersionUID = 833L;
    ...
    public GamingAccountV3() {}

    public GamingAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
