...
/**
 * MySQL Entity: GamingAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingAnalyticsV3 implements Serializable {
    ...
    public GamingAnalyticsV3() {}

    public GamingAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
