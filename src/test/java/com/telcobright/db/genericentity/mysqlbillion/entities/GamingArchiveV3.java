...
/**
 * MySQL Entity: GamingArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingArchiveV3 implements Serializable {
    ...
    public GamingArchiveV3() {}

    public GamingArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
