...
/**
 * MySQL Entity: GamingCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingCertificateV3 implements Serializable {
    private static final long serialVersionUID = 839L;
    ...
    public GamingCertificateV3() {}

    public GamingCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
