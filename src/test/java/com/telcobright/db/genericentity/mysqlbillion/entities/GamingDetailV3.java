...
/**
 * MySQL Entity: GamingDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingDetailV3 implements Serializable {
    ...
    public GamingDetailV3() {}

    public GamingDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
