...
/**
 * MySQL Entity: GamingDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingDocumentV3 implements Serializable {
    private static final long serialVersionUID = 836L;
    ...
    public GamingDocumentV3() {}

    public GamingDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
