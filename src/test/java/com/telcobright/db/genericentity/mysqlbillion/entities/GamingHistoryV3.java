...
/**
 * MySQL Entity: GamingHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingHistoryV3 implements Serializable {
    ...
    public GamingHistoryV3() {}

    public GamingHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
