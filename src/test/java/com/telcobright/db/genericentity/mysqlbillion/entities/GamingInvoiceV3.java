...
/**
 * MySQL Entity: GamingInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingInvoiceV3 implements Serializable {
    private static final long serialVersionUID = 842L;
    ...
    public GamingInvoiceV3() {}

    public GamingInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
