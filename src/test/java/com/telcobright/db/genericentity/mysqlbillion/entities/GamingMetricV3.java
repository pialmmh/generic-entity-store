...
/**
 * MySQL Entity: GamingMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingMetricV3 implements Serializable {
    private static final long serialVersionUID = 824L;
    ...
    public GamingMetricV3() {}

    public GamingMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
