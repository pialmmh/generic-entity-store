...
/**
 * MySQL Entity: GamingOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingOrderV3 implements Serializable {
    private static final long serialVersionUID = 845L;
    ...
    public GamingOrderV3() {}

    public GamingOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
