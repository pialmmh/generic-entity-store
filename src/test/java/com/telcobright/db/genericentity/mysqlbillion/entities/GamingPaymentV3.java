...
/**
 * MySQL Entity: GamingPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingPaymentV3 implements Serializable {
    ...
    public GamingPaymentV3() {}

    public GamingPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
