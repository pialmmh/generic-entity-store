...
/**
 * MySQL Entity: GamingProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingProfileV3 implements Serializable {
    ...
    public GamingProfileV3() {}

    public GamingProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
