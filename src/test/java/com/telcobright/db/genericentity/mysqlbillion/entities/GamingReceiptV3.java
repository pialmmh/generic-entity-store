...
/**
 * MySQL Entity: GamingReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingReceiptV3 implements Serializable {
    ...
    public GamingReceiptV3() {}

    public GamingReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
