...
/**
 * MySQL Entity: GamingReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingReportV3 implements Serializable {
    private static final long serialVersionUID = 821L;
    ...
    public GamingReportV3() {}

    public GamingReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
