...
/**
 * MySQL Entity: GamingStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingStatementV3 implements Serializable {
    ...
    public GamingStatementV3() {}

    public GamingStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
