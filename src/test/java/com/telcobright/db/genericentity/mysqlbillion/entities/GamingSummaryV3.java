...
/**
 * MySQL Entity: GamingSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingSummaryV3 implements Serializable {
    ...
    public GamingSummaryV3() {}

    public GamingSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
