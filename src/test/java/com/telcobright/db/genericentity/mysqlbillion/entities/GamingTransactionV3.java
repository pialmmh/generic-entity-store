...
/**
 * MySQL Entity: GamingTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GamingTransactionV3 implements Serializable {
    private static final long serialVersionUID = 794L;
    ...
    public GamingTransactionV3() {}

    public GamingTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
