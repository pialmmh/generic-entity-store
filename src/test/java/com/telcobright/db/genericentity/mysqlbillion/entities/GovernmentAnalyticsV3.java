...
/**
 * MySQL Entity: GovernmentAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentAnalyticsV3 implements Serializable {
    ...
    public GovernmentAnalyticsV3() {}

    public GovernmentAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
