...
/**
 * MySQL Entity: GovernmentArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentArchiveV3 implements Serializable {
    ...
    public GovernmentArchiveV3() {}

    public GovernmentArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
