...
/**
 * MySQL Entity: GovernmentAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentAuditV3 implements Serializable {
    ...
    public GovernmentAuditV3() {}

    public GovernmentAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
