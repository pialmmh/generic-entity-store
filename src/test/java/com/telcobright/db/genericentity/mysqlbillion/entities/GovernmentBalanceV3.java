...
/**
 * MySQL Entity: GovernmentBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentBalanceV3 implements Serializable {
    ...
    public GovernmentBalanceV3() {}

    public GovernmentBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
