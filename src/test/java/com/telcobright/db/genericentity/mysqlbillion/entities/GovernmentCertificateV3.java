...
/**
 * MySQL Entity: GovernmentCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentCertificateV3 implements Serializable {
    ...
    public GovernmentCertificateV3() {}

    public GovernmentCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
