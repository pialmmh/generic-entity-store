...
/**
 * MySQL Entity: GovernmentDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentDetailV3 implements Serializable {
    ...
    public GovernmentDetailV3() {}

    public GovernmentDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
