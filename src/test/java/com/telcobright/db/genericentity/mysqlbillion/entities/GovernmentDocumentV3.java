...
/**
 * MySQL Entity: GovernmentDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentDocumentV3 implements Serializable {
    ...
    public GovernmentDocumentV3() {}

    public GovernmentDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
