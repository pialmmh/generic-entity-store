...
/**
 * MySQL Entity: GovernmentEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentEntryV3 implements Serializable {
    ...
    public GovernmentEntryV3() {}

    public GovernmentEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
