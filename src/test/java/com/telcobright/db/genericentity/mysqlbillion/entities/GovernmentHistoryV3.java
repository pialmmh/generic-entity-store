...
/**
 * MySQL Entity: GovernmentHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentHistoryV3 implements Serializable {
    ...
    public GovernmentHistoryV3() {}

    public GovernmentHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
