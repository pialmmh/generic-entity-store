...
/**
 * MySQL Entity: GovernmentInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentInvoiceV3 implements Serializable {
    ...
    public GovernmentInvoiceV3() {}

    public GovernmentInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
