...
/**
 * MySQL Entity: GovernmentLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentLogV3 implements Serializable {
    ...
    public GovernmentLogV3() {}

    public GovernmentLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
