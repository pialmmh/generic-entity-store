...
/**
 * MySQL Entity: GovernmentMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentMetricV3 implements Serializable {
    ...
    public GovernmentMetricV3() {}

    public GovernmentMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
