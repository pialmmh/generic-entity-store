...
/**
 * MySQL Entity: GovernmentOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentOrderV3 implements Serializable {
    ...
    public GovernmentOrderV3() {}

    public GovernmentOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
