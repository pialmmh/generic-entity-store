...
/**
 * MySQL Entity: GovernmentPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentPaymentV3 implements Serializable {
    ...
    public GovernmentPaymentV3() {}

    public GovernmentPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
