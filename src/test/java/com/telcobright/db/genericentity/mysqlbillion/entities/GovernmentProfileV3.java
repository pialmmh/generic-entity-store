...
/**
 * MySQL Entity: GovernmentProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentProfileV3 implements Serializable {
    ...
    public GovernmentProfileV3() {}

    public GovernmentProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
