...
/**
 * MySQL Entity: GovernmentReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentReceiptV3 implements Serializable {
    ...
    public GovernmentReceiptV3() {}

    public GovernmentReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
