...
/**
 * MySQL Entity: GovernmentRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentRecordV3 implements Serializable {
    ...
    public GovernmentRecordV3() {}

    public GovernmentRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
