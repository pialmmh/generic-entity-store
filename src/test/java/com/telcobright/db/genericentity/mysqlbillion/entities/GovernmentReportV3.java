...
/**
 * MySQL Entity: GovernmentReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentReportV3 implements Serializable {
    ...
    public GovernmentReportV3() {}

    public GovernmentReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
