...
/**
 * MySQL Entity: GovernmentStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentStatementV3 implements Serializable {
    ...
    public GovernmentStatementV3() {}

    public GovernmentStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
