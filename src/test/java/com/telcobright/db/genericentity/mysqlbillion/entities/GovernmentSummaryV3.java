...
/**
 * MySQL Entity: GovernmentSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentSummaryV3 implements Serializable {
    ...
    public GovernmentSummaryV3() {}

    public GovernmentSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
