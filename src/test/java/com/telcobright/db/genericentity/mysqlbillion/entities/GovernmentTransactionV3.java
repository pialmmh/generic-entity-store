...
/**
 * MySQL Entity: GovernmentTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class GovernmentTransactionV3 implements Serializable {
    ...
    public GovernmentTransactionV3() {}

    public GovernmentTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
