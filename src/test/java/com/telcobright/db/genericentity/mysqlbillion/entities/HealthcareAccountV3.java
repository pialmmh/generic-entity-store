...
/**
 * MySQL Entity: HealthcareAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareAccountV3 implements Serializable {
    ...
    public HealthcareAccountV3() {}

    public HealthcareAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
