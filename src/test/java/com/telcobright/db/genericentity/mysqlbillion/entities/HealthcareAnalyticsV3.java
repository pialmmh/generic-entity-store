...
/**
 * MySQL Entity: HealthcareAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareAnalyticsV3 implements Serializable {
    ...
    public HealthcareAnalyticsV3() {}

    public HealthcareAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
