...
/**
 * MySQL Entity: HealthcareArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareArchiveV3 implements Serializable {
    ...
    public HealthcareArchiveV3() {}

    public HealthcareArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
