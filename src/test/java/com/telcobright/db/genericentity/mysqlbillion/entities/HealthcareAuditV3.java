...
/**
 * MySQL Entity: HealthcareAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareAuditV3 implements Serializable {
    ...
    public HealthcareAuditV3() {}

    public HealthcareAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
