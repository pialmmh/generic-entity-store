...
/**
 * MySQL Entity: HealthcareBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareBalanceV3 implements Serializable {
    ...
    public HealthcareBalanceV3() {}

    public HealthcareBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
