...
/**
 * MySQL Entity: HealthcareCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareCertificateV3 implements Serializable {
    ...
    public HealthcareCertificateV3() {}

    public HealthcareCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
