...
/**
 * MySQL Entity: HealthcareDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareDetailV3 implements Serializable {
    ...
    public HealthcareDetailV3() {}

    public HealthcareDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
