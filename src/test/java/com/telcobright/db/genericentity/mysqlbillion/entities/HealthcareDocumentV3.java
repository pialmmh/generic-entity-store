...
/**
 * MySQL Entity: HealthcareDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareDocumentV3 implements Serializable {
    ...
    public HealthcareDocumentV3() {}

    public HealthcareDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
