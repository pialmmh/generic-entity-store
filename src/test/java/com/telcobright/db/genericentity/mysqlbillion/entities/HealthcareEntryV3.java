...
/**
 * MySQL Entity: HealthcareEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareEntryV3 implements Serializable {
    ...
    public HealthcareEntryV3() {}

    public HealthcareEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
