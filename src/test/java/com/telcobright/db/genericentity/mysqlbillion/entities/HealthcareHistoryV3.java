...
/**
 * MySQL Entity: HealthcareHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareHistoryV3 implements Serializable {
    ...
    public HealthcareHistoryV3() {}

    public HealthcareHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
