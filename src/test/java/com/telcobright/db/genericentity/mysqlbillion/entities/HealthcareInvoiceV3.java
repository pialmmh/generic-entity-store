...
/**
 * MySQL Entity: HealthcareInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareInvoiceV3 implements Serializable {
    ...
    public HealthcareInvoiceV3() {}

    public HealthcareInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
