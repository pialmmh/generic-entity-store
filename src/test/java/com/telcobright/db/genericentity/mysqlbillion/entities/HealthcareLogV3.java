...
/**
 * MySQL Entity: HealthcareLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareLogV3 implements Serializable {
    ...
    public HealthcareLogV3() {}

    public HealthcareLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
