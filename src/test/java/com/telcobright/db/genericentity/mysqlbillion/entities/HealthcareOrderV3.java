...
/**
 * MySQL Entity: HealthcareOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareOrderV3 implements Serializable {
    ...
    public HealthcareOrderV3() {}

    public HealthcareOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
