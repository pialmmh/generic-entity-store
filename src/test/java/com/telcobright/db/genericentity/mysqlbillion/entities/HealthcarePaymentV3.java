...
/**
 * MySQL Entity: HealthcarePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcarePaymentV3 implements Serializable {
    ...
    public HealthcarePaymentV3() {}

    public HealthcarePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
