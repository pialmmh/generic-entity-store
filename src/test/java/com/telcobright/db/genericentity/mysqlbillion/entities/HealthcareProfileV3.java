...
/**
 * MySQL Entity: HealthcareProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareProfileV3 implements Serializable {
    ...
    public HealthcareProfileV3() {}

    public HealthcareProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
