...
/**
 * MySQL Entity: HealthcareReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareReceiptV3 implements Serializable {
    ...
    public HealthcareReceiptV3() {}

    public HealthcareReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
