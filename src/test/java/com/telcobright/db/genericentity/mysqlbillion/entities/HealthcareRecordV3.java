...
/**
 * MySQL Entity: HealthcareRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareRecordV3 implements Serializable {
    ...
    public HealthcareRecordV3() {}

    public HealthcareRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
