...
/**
 * MySQL Entity: HealthcareReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareReportV3 implements Serializable {
    ...
    public HealthcareReportV3() {}

    public HealthcareReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
