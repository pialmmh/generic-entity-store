...
/**
 * MySQL Entity: HealthcareStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareStatementV3 implements Serializable {
    ...
    public HealthcareStatementV3() {}

    public HealthcareStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
