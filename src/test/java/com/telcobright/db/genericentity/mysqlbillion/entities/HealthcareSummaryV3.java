...
/**
 * MySQL Entity: HealthcareSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareSummaryV3 implements Serializable {
    ...
    public HealthcareSummaryV3() {}

    public HealthcareSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
