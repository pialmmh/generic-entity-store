...
/**
 * MySQL Entity: HealthcareTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HealthcareTransactionV3 implements Serializable {
    ...
    public HealthcareTransactionV3() {}

    public HealthcareTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
