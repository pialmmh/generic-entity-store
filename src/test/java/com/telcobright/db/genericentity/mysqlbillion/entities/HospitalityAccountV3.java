...
/**
 * MySQL Entity: HospitalityAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityAccountV3 implements Serializable {
    ...
    public HospitalityAccountV3() {}

    public HospitalityAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
