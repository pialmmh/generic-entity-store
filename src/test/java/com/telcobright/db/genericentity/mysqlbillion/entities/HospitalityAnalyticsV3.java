...
/**
 * MySQL Entity: HospitalityAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityAnalyticsV3 implements Serializable {
    ...
    public HospitalityAnalyticsV3() {}

    public HospitalityAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
