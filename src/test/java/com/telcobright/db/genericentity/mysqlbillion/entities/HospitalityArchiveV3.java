...
/**
 * MySQL Entity: HospitalityArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityArchiveV3 implements Serializable {
    ...
    public HospitalityArchiveV3() {}

    public HospitalityArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
