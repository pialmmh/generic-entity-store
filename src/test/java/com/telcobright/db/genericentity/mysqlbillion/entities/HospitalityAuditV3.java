...
/**
 * MySQL Entity: HospitalityAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityAuditV3 implements Serializable {
    ...
    public HospitalityAuditV3() {}

    public HospitalityAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
