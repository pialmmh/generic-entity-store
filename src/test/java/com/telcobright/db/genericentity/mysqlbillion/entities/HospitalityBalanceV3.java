...
/**
 * MySQL Entity: HospitalityBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityBalanceV3 implements Serializable {
    ...
    public HospitalityBalanceV3() {}

    public HospitalityBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
