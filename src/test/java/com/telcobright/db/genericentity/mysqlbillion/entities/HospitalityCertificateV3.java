...
/**
 * MySQL Entity: HospitalityCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityCertificateV3 implements Serializable {
    ...
    public HospitalityCertificateV3() {}

    public HospitalityCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
