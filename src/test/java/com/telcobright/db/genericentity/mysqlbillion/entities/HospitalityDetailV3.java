...
/**
 * MySQL Entity: HospitalityDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityDetailV3 implements Serializable {
    ...
    public HospitalityDetailV3() {}

    public HospitalityDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
