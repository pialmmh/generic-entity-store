...
/**
 * MySQL Entity: HospitalityDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityDocumentV3 implements Serializable {
    ...
    public HospitalityDocumentV3() {}

    public HospitalityDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
