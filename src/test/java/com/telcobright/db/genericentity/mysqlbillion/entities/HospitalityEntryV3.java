...
/**
 * MySQL Entity: HospitalityEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityEntryV3 implements Serializable {
    ...
    public HospitalityEntryV3() {}

    public HospitalityEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
