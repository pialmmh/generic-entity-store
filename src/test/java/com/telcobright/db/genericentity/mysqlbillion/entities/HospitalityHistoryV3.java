...
/**
 * MySQL Entity: HospitalityHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityHistoryV3 implements Serializable {
    ...
    public HospitalityHistoryV3() {}

    public HospitalityHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
