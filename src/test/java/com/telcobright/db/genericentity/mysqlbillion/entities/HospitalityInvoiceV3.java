...
/**
 * MySQL Entity: HospitalityInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityInvoiceV3 implements Serializable {
    ...
    public HospitalityInvoiceV3() {}

    public HospitalityInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
