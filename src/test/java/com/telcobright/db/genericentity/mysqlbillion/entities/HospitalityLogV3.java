...
/**
 * MySQL Entity: HospitalityLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityLogV3 implements Serializable {
    ...
    public HospitalityLogV3() {}

    public HospitalityLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
