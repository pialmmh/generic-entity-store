...
/**
 * MySQL Entity: HospitalityMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityMetricV3 implements Serializable {
    ...
    public HospitalityMetricV3() {}

    public HospitalityMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
