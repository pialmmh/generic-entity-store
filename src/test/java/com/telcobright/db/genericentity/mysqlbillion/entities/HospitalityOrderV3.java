...
/**
 * MySQL Entity: HospitalityOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityOrderV3 implements Serializable {
    ...
    public HospitalityOrderV3() {}

    public HospitalityOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
