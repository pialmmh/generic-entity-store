...
/**
 * MySQL Entity: HospitalityProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityProfileV3 implements Serializable {
    ...
    public HospitalityProfileV3() {}

    public HospitalityProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
