...
/**
 * MySQL Entity: HospitalityReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityReceiptV3 implements Serializable {
    ...
    public HospitalityReceiptV3() {}

    public HospitalityReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
