...
/**
 * MySQL Entity: HospitalityRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityRecordV3 implements Serializable {
    ...
    public HospitalityRecordV3() {}

    public HospitalityRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
