...
/**
 * MySQL Entity: HospitalityReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityReportV3 implements Serializable {
    ...
    public HospitalityReportV3() {}

    public HospitalityReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
