...
/**
 * MySQL Entity: HospitalityStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityStatementV3 implements Serializable {
    ...
    public HospitalityStatementV3() {}

    public HospitalityStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
