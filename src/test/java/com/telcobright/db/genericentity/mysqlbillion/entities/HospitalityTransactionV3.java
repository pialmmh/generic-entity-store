...
/**
 * MySQL Entity: HospitalityTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class HospitalityTransactionV3 implements Serializable {
    ...
    public HospitalityTransactionV3() {}

    public HospitalityTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
