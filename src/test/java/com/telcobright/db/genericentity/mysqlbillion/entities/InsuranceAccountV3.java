...
/**
 * MySQL Entity: InsuranceAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceAccountV3 implements Serializable {
    private static final long serialVersionUID = 569L;
    ...
    public InsuranceAccountV3() {}

    public InsuranceAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
