...
/**
 * MySQL Entity: InsuranceAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceAnalyticsV3 implements Serializable {
    ...
    public InsuranceAnalyticsV3() {}

    public InsuranceAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
