...
/**
 * MySQL Entity: InsuranceArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceArchiveV3 implements Serializable {
    ...
    public InsuranceArchiveV3() {}

    public InsuranceArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
