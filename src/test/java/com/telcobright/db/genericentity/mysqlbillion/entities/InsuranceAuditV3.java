...
/**
 * MySQL Entity: InsuranceAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceAuditV3 implements Serializable {
    ...
    public InsuranceAuditV3() {}

    public InsuranceAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
