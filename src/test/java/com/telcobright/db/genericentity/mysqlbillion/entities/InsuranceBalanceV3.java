...
/**
 * MySQL Entity: InsuranceBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceBalanceV3 implements Serializable {
    ...
    public InsuranceBalanceV3() {}

    public InsuranceBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
