...
/**
 * MySQL Entity: InsuranceCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceCertificateV3 implements Serializable {
    ...
    public InsuranceCertificateV3() {}

    public InsuranceCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
