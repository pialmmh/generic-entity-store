...
/**
 * MySQL Entity: InsuranceDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceDetailV3 implements Serializable {
    ...
    public InsuranceDetailV3() {}

    public InsuranceDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
