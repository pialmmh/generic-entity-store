...
/**
 * MySQL Entity: InsuranceDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceDocumentV3 implements Serializable {
    ...
    public InsuranceDocumentV3() {}

    public InsuranceDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
