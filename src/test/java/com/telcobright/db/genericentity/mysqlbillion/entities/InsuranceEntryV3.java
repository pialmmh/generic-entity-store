...
/**
 * MySQL Entity: InsuranceEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceEntryV3 implements Serializable {
    ...
    public InsuranceEntryV3() {}

    public InsuranceEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
