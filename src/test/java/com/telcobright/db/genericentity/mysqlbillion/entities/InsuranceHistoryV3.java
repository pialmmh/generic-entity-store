...
/**
 * MySQL Entity: InsuranceHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceHistoryV3 implements Serializable {
    ...
    public InsuranceHistoryV3() {}

    public InsuranceHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
