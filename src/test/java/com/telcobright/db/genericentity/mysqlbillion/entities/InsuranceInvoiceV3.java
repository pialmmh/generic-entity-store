...
/**
 * MySQL Entity: InsuranceInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceInvoiceV3 implements Serializable {
    private static final long serialVersionUID = 578L;
    ...
    public InsuranceInvoiceV3() {}

    public InsuranceInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
