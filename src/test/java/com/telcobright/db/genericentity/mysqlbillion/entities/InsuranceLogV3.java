...
/**
 * MySQL Entity: InsuranceLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceLogV3 implements Serializable {
    ...
    public InsuranceLogV3() {}

    public InsuranceLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
