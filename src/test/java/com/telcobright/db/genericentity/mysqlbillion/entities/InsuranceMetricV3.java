...
/**
 * MySQL Entity: InsuranceMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceMetricV3 implements Serializable {
    ...
    public InsuranceMetricV3() {}

    public InsuranceMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
