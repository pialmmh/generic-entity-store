...
/**
 * MySQL Entity: InsuranceOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceOrderV3 implements Serializable {
    private static final long serialVersionUID = 581L;
    ...
    public InsuranceOrderV3() {}

    public InsuranceOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
