...
/**
 * MySQL Entity: InsurancePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsurancePaymentV3 implements Serializable {
    ...
    public InsurancePaymentV3() {}

    public InsurancePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
