...
/**
 * MySQL Entity: InsuranceProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceProfileV3 implements Serializable {
    ...
    public InsuranceProfileV3() {}

    public InsuranceProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
