...
/**
 * MySQL Entity: InsuranceReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceReceiptV3 implements Serializable {
    ...
    public InsuranceReceiptV3() {}

    public InsuranceReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
