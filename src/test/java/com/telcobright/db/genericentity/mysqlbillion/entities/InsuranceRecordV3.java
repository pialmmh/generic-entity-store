...
/**
 * MySQL Entity: InsuranceRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceRecordV3 implements Serializable {
    ...
    public InsuranceRecordV3() {}

    public InsuranceRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
