...
/**
 * MySQL Entity: InsuranceReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceReportV3 implements Serializable {
    ...
    public InsuranceReportV3() {}

    public InsuranceReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
