...
/**
 * MySQL Entity: InsuranceStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceStatementV3 implements Serializable {
    ...
    public InsuranceStatementV3() {}

    public InsuranceStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
