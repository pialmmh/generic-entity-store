...
/**
 * MySQL Entity: InsuranceSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceSummaryV3 implements Serializable {
    ...
    public InsuranceSummaryV3() {}

    public InsuranceSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
