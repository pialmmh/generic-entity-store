...
/**
 * MySQL Entity: InsuranceTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class InsuranceTransactionV3 implements Serializable {
    ...
    public InsuranceTransactionV3() {}

    public InsuranceTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
