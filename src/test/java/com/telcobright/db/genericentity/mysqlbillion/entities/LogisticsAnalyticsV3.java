...
/**
 * MySQL Entity: LogisticsAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsAnalyticsV3 implements Serializable {
    ...
    public LogisticsAnalyticsV3() {}

    public LogisticsAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
