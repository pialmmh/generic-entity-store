...
/**
 * MySQL Entity: LogisticsArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsArchiveV3 implements Serializable {
    ...
    public LogisticsArchiveV3() {}

    public LogisticsArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
