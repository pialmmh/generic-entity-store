...
/**
 * MySQL Entity: LogisticsAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsAuditV3 implements Serializable {
    ...
    public LogisticsAuditV3() {}

    public LogisticsAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
