...
/**
 * MySQL Entity: LogisticsBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsBalanceV3 implements Serializable {
    ...
    public LogisticsBalanceV3() {}

    public LogisticsBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
