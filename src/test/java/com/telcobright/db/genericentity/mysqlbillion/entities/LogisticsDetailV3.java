...
/**
 * MySQL Entity: LogisticsDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsDetailV3 implements Serializable {
    ...
    public LogisticsDetailV3() {}

    public LogisticsDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
