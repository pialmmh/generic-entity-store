...
/**
 * MySQL Entity: LogisticsDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsDocumentV3 implements Serializable {
    ...
    public LogisticsDocumentV3() {}

    public LogisticsDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
