...
/**
 * MySQL Entity: LogisticsEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsEntryV3 implements Serializable {
    ...
    public LogisticsEntryV3() {}

    public LogisticsEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
