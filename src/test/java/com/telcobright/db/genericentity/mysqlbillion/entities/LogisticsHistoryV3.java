...
/**
 * MySQL Entity: LogisticsHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsHistoryV3 implements Serializable {
    ...
    public LogisticsHistoryV3() {}

    public LogisticsHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
