...
/**
 * MySQL Entity: LogisticsInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsInvoiceV3 implements Serializable {
    ...
    public LogisticsInvoiceV3() {}

    public LogisticsInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
