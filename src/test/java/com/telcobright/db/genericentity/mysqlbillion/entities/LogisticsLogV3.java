...
/**
 * MySQL Entity: LogisticsLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsLogV3 implements Serializable {
    ...
    public LogisticsLogV3() {}

    public LogisticsLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
