...
/**
 * MySQL Entity: LogisticsMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsMetricV3 implements Serializable {
    private static final long serialVersionUID = 296L;
    ...
    public LogisticsMetricV3() {}

    public LogisticsMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
