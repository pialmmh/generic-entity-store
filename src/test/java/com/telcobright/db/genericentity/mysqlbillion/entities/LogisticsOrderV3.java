...
/**
 * MySQL Entity: LogisticsOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsOrderV3 implements Serializable {
    ...
    public LogisticsOrderV3() {}

    public LogisticsOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
