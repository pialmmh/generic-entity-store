...
/**
 * MySQL Entity: LogisticsPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsPaymentV3 implements Serializable {
    ...
    public LogisticsPaymentV3() {}

    public LogisticsPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
