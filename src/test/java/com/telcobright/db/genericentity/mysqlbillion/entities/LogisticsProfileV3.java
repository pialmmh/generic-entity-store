...
/**
 * MySQL Entity: LogisticsProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsProfileV3 implements Serializable {
    ...
    public LogisticsProfileV3() {}

    public LogisticsProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
