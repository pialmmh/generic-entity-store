...
/**
 * MySQL Entity: LogisticsReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsReceiptV3 implements Serializable {
    ...
    public LogisticsReceiptV3() {}

    public LogisticsReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
