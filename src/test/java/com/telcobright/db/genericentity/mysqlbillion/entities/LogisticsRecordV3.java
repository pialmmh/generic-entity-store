...
/**
 * MySQL Entity: LogisticsRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsRecordV3 implements Serializable {
    ...
    public LogisticsRecordV3() {}

    public LogisticsRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
