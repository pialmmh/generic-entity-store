...
/**
 * MySQL Entity: LogisticsReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsReportV3 implements Serializable {
    ...
    public LogisticsReportV3() {}

    public LogisticsReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
