...
/**
 * MySQL Entity: LogisticsStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsStatementV3 implements Serializable {
    ...
    public LogisticsStatementV3() {}

    public LogisticsStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
