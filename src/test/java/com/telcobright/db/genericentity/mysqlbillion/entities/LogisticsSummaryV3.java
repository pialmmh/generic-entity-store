...
/**
 * MySQL Entity: LogisticsSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsSummaryV3 implements Serializable {
    ...
    public LogisticsSummaryV3() {}

    public LogisticsSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
