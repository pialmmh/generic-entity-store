...
/**
 * MySQL Entity: LogisticsTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class LogisticsTransactionV3 implements Serializable {
    ...
    public LogisticsTransactionV3() {}

    public LogisticsTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
