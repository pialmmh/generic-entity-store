...
/**
 * MySQL Entity: ManufacturingAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingAccountV3 implements Serializable {
    ...
    public ManufacturingAccountV3() {}

    public ManufacturingAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
