...
/**
 * MySQL Entity: ManufacturingAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingAnalyticsV3 implements Serializable {
    ...
    public ManufacturingAnalyticsV3() {}

    public ManufacturingAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
