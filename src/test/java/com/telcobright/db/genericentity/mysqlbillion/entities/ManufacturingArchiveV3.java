...
/**
 * MySQL Entity: ManufacturingArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingArchiveV3 implements Serializable {
    ...
    public ManufacturingArchiveV3() {}

    public ManufacturingArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
