...
/**
 * MySQL Entity: ManufacturingAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingAuditV3 implements Serializable {
    ...
    public ManufacturingAuditV3() {}

    public ManufacturingAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
