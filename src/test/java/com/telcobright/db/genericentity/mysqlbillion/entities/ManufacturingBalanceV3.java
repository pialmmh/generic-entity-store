...
/**
 * MySQL Entity: ManufacturingBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingBalanceV3 implements Serializable {
    ...
    public ManufacturingBalanceV3() {}

    public ManufacturingBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
