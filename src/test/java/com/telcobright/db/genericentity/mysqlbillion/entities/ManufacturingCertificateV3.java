...
/**
 * MySQL Entity: ManufacturingCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingCertificateV3 implements Serializable {
    ...
    public ManufacturingCertificateV3() {}

    public ManufacturingCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
