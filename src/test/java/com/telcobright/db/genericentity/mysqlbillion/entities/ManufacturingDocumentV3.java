...
/**
 * MySQL Entity: ManufacturingDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingDocumentV3 implements Serializable {
    ...
    public ManufacturingDocumentV3() {}

    public ManufacturingDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
