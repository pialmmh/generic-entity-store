...
/**
 * MySQL Entity: ManufacturingEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingEntryV3 implements Serializable {
    ...
    public ManufacturingEntryV3() {}

    public ManufacturingEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
