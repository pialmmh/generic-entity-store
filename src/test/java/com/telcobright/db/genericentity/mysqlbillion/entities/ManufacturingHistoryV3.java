...
/**
 * MySQL Entity: ManufacturingHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingHistoryV3 implements Serializable {
    ...
    public ManufacturingHistoryV3() {}

    public ManufacturingHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
