...
/**
 * MySQL Entity: ManufacturingInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingInvoiceV3 implements Serializable {
    ...
    public ManufacturingInvoiceV3() {}

    public ManufacturingInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
