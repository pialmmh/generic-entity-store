...
/**
 * MySQL Entity: ManufacturingLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingLogV3 implements Serializable {
    ...
    public ManufacturingLogV3() {}

    public ManufacturingLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
