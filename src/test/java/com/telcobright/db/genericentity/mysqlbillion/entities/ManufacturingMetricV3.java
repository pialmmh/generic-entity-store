...
/**
 * MySQL Entity: ManufacturingMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingMetricV3 implements Serializable {
    ...
    public ManufacturingMetricV3() {}

    public ManufacturingMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
