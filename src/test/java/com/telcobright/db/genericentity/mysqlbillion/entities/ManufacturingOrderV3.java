...
/**
 * MySQL Entity: ManufacturingOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingOrderV3 implements Serializable {
    ...
    public ManufacturingOrderV3() {}

    public ManufacturingOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
