...
/**
 * MySQL Entity: ManufacturingPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingPaymentV3 implements Serializable {
    ...
    public ManufacturingPaymentV3() {}

    public ManufacturingPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
