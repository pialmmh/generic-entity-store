...
/**
 * MySQL Entity: ManufacturingProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingProfileV3 implements Serializable {
    ...
    public ManufacturingProfileV3() {}

    public ManufacturingProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
