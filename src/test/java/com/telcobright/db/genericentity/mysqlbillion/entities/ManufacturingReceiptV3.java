...
/**
 * MySQL Entity: ManufacturingReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingReceiptV3 implements Serializable {
    ...
    public ManufacturingReceiptV3() {}

    public ManufacturingReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
