...
/**
 * MySQL Entity: ManufacturingRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingRecordV3 implements Serializable {
    ...
    public ManufacturingRecordV3() {}

    public ManufacturingRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
