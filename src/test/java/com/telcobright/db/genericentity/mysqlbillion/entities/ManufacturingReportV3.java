...
/**
 * MySQL Entity: ManufacturingReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingReportV3 implements Serializable {
    ...
    public ManufacturingReportV3() {}

    public ManufacturingReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
