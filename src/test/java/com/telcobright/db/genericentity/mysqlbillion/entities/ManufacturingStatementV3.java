...
/**
 * MySQL Entity: ManufacturingStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingStatementV3 implements Serializable {
    ...
    public ManufacturingStatementV3() {}

    public ManufacturingStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
