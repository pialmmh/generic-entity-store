...
/**
 * MySQL Entity: ManufacturingSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingSummaryV3 implements Serializable {
    ...
    public ManufacturingSummaryV3() {}

    public ManufacturingSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
