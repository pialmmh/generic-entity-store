...
/**
 * MySQL Entity: ManufacturingTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class ManufacturingTransactionV3 implements Serializable {
    ...
    public ManufacturingTransactionV3() {}

    public ManufacturingTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
