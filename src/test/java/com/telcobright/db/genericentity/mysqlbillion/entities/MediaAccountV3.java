...
/**
 * MySQL Entity: MediaAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaAccountV3 implements Serializable {
    ...
    public MediaAccountV3() {}

    public MediaAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
