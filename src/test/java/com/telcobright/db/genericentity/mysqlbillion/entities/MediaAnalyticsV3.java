...
/**
 * MySQL Entity: MediaAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaAnalyticsV3 implements Serializable {
    private static final long serialVersionUID = 893L;
    ...
    public MediaAnalyticsV3() {}

    public MediaAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
