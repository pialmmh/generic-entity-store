...
/**
 * MySQL Entity: MediaArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaArchiveV3 implements Serializable {
    ...
    public MediaArchiveV3() {}

    public MediaArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
