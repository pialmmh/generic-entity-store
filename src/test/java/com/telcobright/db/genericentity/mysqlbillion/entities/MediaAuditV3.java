...
/**
 * MySQL Entity: MediaAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaAuditV3 implements Serializable {
    private static final long serialVersionUID = 884L;
    ...
    public MediaAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
