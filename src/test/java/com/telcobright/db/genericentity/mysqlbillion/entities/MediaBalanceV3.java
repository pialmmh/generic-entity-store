...
/**
 * MySQL Entity: MediaBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaBalanceV3 implements Serializable {
    private static final long serialVersionUID = 923L;
    ...
    public MediaBalanceV3() {}

    public MediaBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
