...
/**
 * MySQL Entity: MediaCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaCertificateV3 implements Serializable {
    ...
    public MediaCertificateV3() {}

    public MediaCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
