...
/**
 * MySQL Entity: MediaDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaDetailV3 implements Serializable {
    private static final long serialVersionUID = 872L;
    ...
    public MediaDetailV3() {}

    public MediaDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
