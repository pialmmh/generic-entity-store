...
/**
 * MySQL Entity: MediaEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaEntryV3 implements Serializable {
    private static final long serialVersionUID = 866L;
    ...
    public MediaEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
