...
/**
 * MySQL Entity: MediaHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaHistoryV3 implements Serializable {
    ...
    public MediaHistoryV3() {}

    public MediaHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
