...
/**
 * MySQL Entity: MediaInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaInvoiceV3 implements Serializable {
    ...
    public MediaInvoiceV3() {}

    public MediaInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
