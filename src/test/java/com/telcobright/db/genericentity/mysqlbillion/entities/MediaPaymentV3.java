...
/**
 * MySQL Entity: MediaPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaPaymentV3 implements Serializable {
    ...
    public MediaPaymentV3() {}

    public MediaPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
