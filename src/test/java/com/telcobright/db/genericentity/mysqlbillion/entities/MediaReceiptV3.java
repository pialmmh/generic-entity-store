...
/**
 * MySQL Entity: MediaReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaReceiptV3 implements Serializable {
    ...
    public MediaReceiptV3() {}

    public MediaReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
