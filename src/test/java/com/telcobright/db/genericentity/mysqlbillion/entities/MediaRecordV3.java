...
/**
 * MySQL Entity: MediaRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaRecordV3 implements Serializable {
    private static final long serialVersionUID = 863L;
    ...
    public MediaRecordV3() {}

    public MediaRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
