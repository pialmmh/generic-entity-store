...
/**
 * MySQL Entity: MediaStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaStatementV3 implements Serializable {
    ...
    public MediaStatementV3() {}

    public MediaStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
