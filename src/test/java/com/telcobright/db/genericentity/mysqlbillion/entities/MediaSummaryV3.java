...
/**
 * MySQL Entity: MediaSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaSummaryV3 implements Serializable {
    ...
    public MediaSummaryV3() {}

    public MediaSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
