...
/**
 * MySQL Entity: MediaTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class MediaTransactionV3 implements Serializable {
    ...
    public MediaTransactionV3() {}

    public MediaTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
