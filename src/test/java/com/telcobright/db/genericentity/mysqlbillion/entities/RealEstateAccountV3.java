...
/**
 * MySQL Entity: RealEstateAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateAccountV3 implements Serializable {
    ...
    public RealEstateAccountV3() {}

    public RealEstateAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
