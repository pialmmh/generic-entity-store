...
/**
 * MySQL Entity: RealEstateAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateAnalyticsV3 implements Serializable {
    ...
    public RealEstateAnalyticsV3() {}

    public RealEstateAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
