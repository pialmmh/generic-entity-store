...
/**
 * MySQL Entity: RealEstateArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateArchiveV3 implements Serializable {
    ...
    public RealEstateArchiveV3() {}

    public RealEstateArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
