...
/**
 * MySQL Entity: RealEstateAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateAuditV3 implements Serializable {
    ...
    public RealEstateAuditV3() {}

    public RealEstateAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
