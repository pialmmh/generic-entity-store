...
/**
 * MySQL Entity: RealEstateBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateBalanceV3 implements Serializable {
    ...
    public RealEstateBalanceV3() {}

    public RealEstateBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
