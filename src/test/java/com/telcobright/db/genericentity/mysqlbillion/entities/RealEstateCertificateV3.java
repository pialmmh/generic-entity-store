...
/**
 * MySQL Entity: RealEstateCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateCertificateV3 implements Serializable {
    ...
    public RealEstateCertificateV3() {}

    public RealEstateCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
