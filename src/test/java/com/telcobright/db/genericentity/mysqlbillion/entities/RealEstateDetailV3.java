...
/**
 * MySQL Entity: RealEstateDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateDetailV3 implements Serializable {
    ...
    public RealEstateDetailV3() {}

    public RealEstateDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
