...
/**
 * MySQL Entity: RealEstateDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateDocumentV3 implements Serializable {
    ...
    public RealEstateDocumentV3() {}

    public RealEstateDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
