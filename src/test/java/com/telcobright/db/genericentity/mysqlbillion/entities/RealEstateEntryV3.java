...
/**
 * MySQL Entity: RealEstateEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateEntryV3 implements Serializable {
    ...
    public RealEstateEntryV3() {}

    public RealEstateEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
