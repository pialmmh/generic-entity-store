...
/**
 * MySQL Entity: RealEstateHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateHistoryV3 implements Serializable {
    ...
    public RealEstateHistoryV3() {}

    public RealEstateHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
