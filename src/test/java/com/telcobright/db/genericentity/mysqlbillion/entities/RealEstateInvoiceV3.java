...
/**
 * MySQL Entity: RealEstateInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateInvoiceV3 implements Serializable {
    ...
    public RealEstateInvoiceV3() {}

    public RealEstateInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
