...
/**
 * MySQL Entity: RealEstateLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateLogV3 implements Serializable {
    ...
    public RealEstateLogV3() {}

    public RealEstateLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
