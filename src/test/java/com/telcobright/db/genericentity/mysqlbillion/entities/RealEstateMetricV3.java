...
/**
 * MySQL Entity: RealEstateMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateMetricV3 implements Serializable {
    ...
    public RealEstateMetricV3() {}

    public RealEstateMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
