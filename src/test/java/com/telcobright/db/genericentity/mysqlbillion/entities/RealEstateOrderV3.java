...
/**
 * MySQL Entity: RealEstateOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateOrderV3 implements Serializable {
    ...
    public RealEstateOrderV3() {}

    public RealEstateOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
