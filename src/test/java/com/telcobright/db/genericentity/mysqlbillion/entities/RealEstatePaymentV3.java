...
/**
 * MySQL Entity: RealEstatePaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstatePaymentV3 implements Serializable {
    ...
    public RealEstatePaymentV3() {}

    public RealEstatePaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
