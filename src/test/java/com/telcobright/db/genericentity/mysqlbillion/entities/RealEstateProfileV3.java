...
/**
 * MySQL Entity: RealEstateProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateProfileV3 implements Serializable {
    ...
    public RealEstateProfileV3() {}

    public RealEstateProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
