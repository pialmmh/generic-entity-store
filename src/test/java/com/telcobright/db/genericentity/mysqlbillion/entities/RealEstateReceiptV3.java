...
/**
 * MySQL Entity: RealEstateReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateReceiptV3 implements Serializable {
    ...
    public RealEstateReceiptV3() {}

    public RealEstateReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
