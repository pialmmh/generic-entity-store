...
/**
 * MySQL Entity: RealEstateRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateRecordV3 implements Serializable {
    ...
    public RealEstateRecordV3() {}

    public RealEstateRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
