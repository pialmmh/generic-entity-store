...
/**
 * MySQL Entity: RealEstateReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateReportV3 implements Serializable {
    ...
    public RealEstateReportV3() {}

    public RealEstateReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
