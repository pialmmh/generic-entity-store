...
/**
 * MySQL Entity: RealEstateStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateStatementV3 implements Serializable {
    ...
    public RealEstateStatementV3() {}

    public RealEstateStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
