...
/**
 * MySQL Entity: RealEstateSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateSummaryV3 implements Serializable {
    ...
    public RealEstateSummaryV3() {}

    public RealEstateSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
