...
/**
 * MySQL Entity: RealEstateTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RealEstateTransactionV3 implements Serializable {
    ...
    public RealEstateTransactionV3() {}

    public RealEstateTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
