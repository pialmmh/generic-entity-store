...
/**
 * MySQL Entity: RetailAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailAccountV3 implements Serializable {
    ...
    public RetailAccountV3() {}

    public RetailAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
