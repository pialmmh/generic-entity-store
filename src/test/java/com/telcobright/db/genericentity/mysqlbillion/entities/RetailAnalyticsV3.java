...
/**
 * MySQL Entity: RetailAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailAnalyticsV3 implements Serializable {
    ...
    public RetailAnalyticsV3() {}

    public RetailAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
