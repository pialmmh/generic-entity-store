...
/**
 * MySQL Entity: RetailArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailArchiveV3 implements Serializable {
    ...
    public RetailArchiveV3() {}

    public RetailArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
