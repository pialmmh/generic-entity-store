...
/**
 * MySQL Entity: RetailBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailBalanceV3 implements Serializable {
    ...
    public RetailBalanceV3() {}

    public RetailBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
