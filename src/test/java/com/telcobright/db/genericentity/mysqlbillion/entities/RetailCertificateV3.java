...
/**
 * MySQL Entity: RetailCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailCertificateV3 implements Serializable {
    ...
    public RetailCertificateV3() {}

    public RetailCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
