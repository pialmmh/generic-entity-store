...
/**
 * MySQL Entity: RetailDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailDetailV3 implements Serializable {
    ...
    public RetailDetailV3() {}

    public RetailDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
