...
/**
 * MySQL Entity: RetailDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailDocumentV3 implements Serializable {
    ...
    public RetailDocumentV3() {}

    public RetailDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
