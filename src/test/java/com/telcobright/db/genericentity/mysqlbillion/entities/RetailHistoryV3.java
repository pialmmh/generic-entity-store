...
/**
 * MySQL Entity: RetailHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailHistoryV3 implements Serializable {
    ...
    public RetailHistoryV3() {}

    public RetailHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
