...
/**
 * MySQL Entity: RetailInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailInvoiceV3 implements Serializable {
    ...
    public RetailInvoiceV3() {}

    public RetailInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
