...
/**
 * MySQL Entity: RetailMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailMetricV3 implements Serializable {
    ...
    public RetailMetricV3() {}

    public RetailMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
