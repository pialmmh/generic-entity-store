...
/**
 * MySQL Entity: RetailPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailPaymentV3 implements Serializable {
    ...
    public RetailPaymentV3() {}

    public RetailPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
