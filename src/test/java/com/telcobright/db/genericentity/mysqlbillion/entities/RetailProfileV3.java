...
/**
 * MySQL Entity: RetailProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailProfileV3 implements Serializable {
    ...
    public RetailProfileV3() {}

    public RetailProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
