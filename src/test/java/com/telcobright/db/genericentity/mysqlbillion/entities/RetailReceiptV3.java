...
/**
 * MySQL Entity: RetailReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailReceiptV3 implements Serializable {
    ...
    public RetailReceiptV3() {}

    public RetailReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
