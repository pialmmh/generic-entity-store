...
/**
 * MySQL Entity: RetailRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailRecordV3 implements Serializable {
    ...
    public RetailRecordV3() {}

    public RetailRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
