...
/**
 * MySQL Entity: RetailReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailReportV3 implements Serializable {
    ...
    public RetailReportV3() {}

    public RetailReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
