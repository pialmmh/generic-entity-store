...
/**
 * MySQL Entity: RetailStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailStatementV3 implements Serializable {
    ...
    public RetailStatementV3() {}

    public RetailStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
