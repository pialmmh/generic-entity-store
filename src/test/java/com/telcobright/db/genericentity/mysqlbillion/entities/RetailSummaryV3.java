...
/**
 * MySQL Entity: RetailSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailSummaryV3 implements Serializable {
    ...
    public RetailSummaryV3() {}

    public RetailSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
