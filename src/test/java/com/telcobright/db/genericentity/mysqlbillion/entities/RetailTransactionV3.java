...
/**
 * MySQL Entity: RetailTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class RetailTransactionV3 implements Serializable {
    ...
    public RetailTransactionV3() {}

    public RetailTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
