...
/**
 * MySQL Entity: SocialAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialAccountV3 implements Serializable {
    ...
    public SocialAccountV3() {}

    public SocialAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
