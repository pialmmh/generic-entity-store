...
/**
 * MySQL Entity: SocialAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialAnalyticsV3 implements Serializable {
    ...
    public SocialAnalyticsV3() {}

    public SocialAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
