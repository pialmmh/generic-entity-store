...
/**
 * MySQL Entity: SocialArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialArchiveV3 implements Serializable {
    ...
    public SocialArchiveV3() {}

    public SocialArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
