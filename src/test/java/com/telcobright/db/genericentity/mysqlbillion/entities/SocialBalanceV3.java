...
/**
 * MySQL Entity: SocialBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialBalanceV3 implements Serializable {
    ...
    public SocialBalanceV3() {}

    public SocialBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
