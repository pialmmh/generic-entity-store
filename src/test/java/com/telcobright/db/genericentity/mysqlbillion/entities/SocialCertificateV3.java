...
/**
 * MySQL Entity: SocialCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialCertificateV3 implements Serializable {
    ...
    public SocialCertificateV3() {}

    public SocialCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
