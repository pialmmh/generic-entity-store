...
/**
 * MySQL Entity: SocialDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialDetailV3 implements Serializable {
    ...
    public SocialDetailV3() {}

    public SocialDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
