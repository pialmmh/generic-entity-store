...
/**
 * MySQL Entity: SocialDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialDocumentV3 implements Serializable {
    ...
    public SocialDocumentV3() {}

    public SocialDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
