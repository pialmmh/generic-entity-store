...
/**
 * MySQL Entity: SocialHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialHistoryV3 implements Serializable {
    ...
    public SocialHistoryV3() {}

    public SocialHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
