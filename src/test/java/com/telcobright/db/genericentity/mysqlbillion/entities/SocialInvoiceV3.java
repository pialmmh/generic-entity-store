...
/**
 * MySQL Entity: SocialInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialInvoiceV3 implements Serializable {
    ...
    public SocialInvoiceV3() {}

    public SocialInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
