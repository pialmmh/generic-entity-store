...
/**
 * MySQL Entity: SocialPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialPaymentV3 implements Serializable {
    ...
    public SocialPaymentV3() {}

    public SocialPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
