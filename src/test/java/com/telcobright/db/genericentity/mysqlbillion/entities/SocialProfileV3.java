...
/**
 * MySQL Entity: SocialProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialProfileV3 implements Serializable {
    private static final long serialVersionUID = 764L;
    ...
    public SocialProfileV3() {}

    public SocialProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
