...
/**
 * MySQL Entity: SocialReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialReceiptV3 implements Serializable {
    private static final long serialVersionUID = 785L;
    ...
    public SocialReceiptV3() {}

    public SocialReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
