...
/**
 * MySQL Entity: SocialReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialReportV3 implements Serializable {
    private static final long serialVersionUID = 755L;
    ...
    public SocialReportV3() {}

    public SocialReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
