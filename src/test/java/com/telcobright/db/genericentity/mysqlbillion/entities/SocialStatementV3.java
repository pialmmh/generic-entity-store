...
/**
 * MySQL Entity: SocialStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialStatementV3 implements Serializable {
    ...
    public SocialStatementV3() {}

    public SocialStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
