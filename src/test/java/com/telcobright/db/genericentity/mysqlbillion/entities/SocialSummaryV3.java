...
/**
 * MySQL Entity: SocialSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialSummaryV3 implements Serializable {
    ...
    public SocialSummaryV3() {}

    public SocialSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
