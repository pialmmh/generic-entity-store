...
/**
 * MySQL Entity: SocialTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SocialTransactionV3 implements Serializable {
    private static final long serialVersionUID = 728L;
    ...
    public SocialTransactionV3() {}

    public SocialTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
