...
/**
 * MySQL Entity: SportsAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsAccountV3 implements Serializable {
    ...
    public SportsAccountV3() {}

    public SportsAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
