...
/**
 * MySQL Entity: SportsAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsAnalyticsV3 implements Serializable {
    ...
    public SportsAnalyticsV3() {}

    public SportsAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
