...
/**
 * MySQL Entity: SportsArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsArchiveV3 implements Serializable {
    ...
    public SportsArchiveV3() {}

    public SportsArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
