...
/**
 * MySQL Entity: SportsBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsBalanceV3 implements Serializable {
    ...
    public SportsBalanceV3() {}

    public SportsBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
