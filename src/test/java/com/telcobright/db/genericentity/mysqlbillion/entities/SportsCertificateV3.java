...
/**
 * MySQL Entity: SportsCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsCertificateV3 implements Serializable {
    ...
    public SportsCertificateV3() {}

    public SportsCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
