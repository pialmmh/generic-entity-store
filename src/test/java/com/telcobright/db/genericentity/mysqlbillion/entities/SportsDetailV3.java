...
/**
 * MySQL Entity: SportsDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsDetailV3 implements Serializable {
    ...
    public SportsDetailV3() {}

    public SportsDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
