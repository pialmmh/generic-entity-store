...
/**
 * MySQL Entity: SportsDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsDocumentV3 implements Serializable {
    ...
    public SportsDocumentV3() {}

    public SportsDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
