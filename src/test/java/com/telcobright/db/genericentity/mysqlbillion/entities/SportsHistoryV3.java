...
/**
 * MySQL Entity: SportsHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsHistoryV3 implements Serializable {
    ...
    public SportsHistoryV3() {}

    public SportsHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
