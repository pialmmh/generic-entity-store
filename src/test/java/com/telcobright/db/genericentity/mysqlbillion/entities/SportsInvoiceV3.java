...
/**
 * MySQL Entity: SportsInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsInvoiceV3 implements Serializable {
    ...
    public SportsInvoiceV3() {}

    public SportsInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
