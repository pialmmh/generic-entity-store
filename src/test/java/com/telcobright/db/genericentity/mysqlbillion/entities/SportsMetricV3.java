...
/**
 * MySQL Entity: SportsMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsMetricV3 implements Serializable {
    ...
    public SportsMetricV3() {}

    public SportsMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
