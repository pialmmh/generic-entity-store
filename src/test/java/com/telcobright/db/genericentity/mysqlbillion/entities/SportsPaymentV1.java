...
/**
 * MySQL Entity: SportsPaymentV1
 * Variant 1 with specific MySQL data type combinations
 */
public class SportsPaymentV1 implements Serializable {
    ...
    public SportsPaymentV1() {}

    public SportsPaymentV1(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
