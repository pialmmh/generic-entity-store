...
/**
 * MySQL Entity: SportsPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsPaymentV3 implements Serializable {
    ...
    public SportsPaymentV3() {}

    public SportsPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
