...
/**
 * MySQL Entity: SportsProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsProfileV3 implements Serializable {
    ...
    public SportsProfileV3() {}

    public SportsProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
