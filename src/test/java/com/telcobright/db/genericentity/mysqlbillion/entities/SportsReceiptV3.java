...
/**
 * MySQL Entity: SportsReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsReceiptV3 implements Serializable {
    ...
    public SportsReceiptV3() {}

    public SportsReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
