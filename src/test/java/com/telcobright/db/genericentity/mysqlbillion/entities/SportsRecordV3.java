...
/**
 * MySQL Entity: SportsRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsRecordV3 implements Serializable {
    ...
    public SportsRecordV3() {}

    public SportsRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
