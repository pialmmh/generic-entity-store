...
/**
 * MySQL Entity: SportsReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsReportV3 implements Serializable {
    ...
    public SportsReportV3() {}

    public SportsReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
