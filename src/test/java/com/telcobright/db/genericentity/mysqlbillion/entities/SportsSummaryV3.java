...
/**
 * MySQL Entity: SportsSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class SportsSummaryV3 implements Serializable {
    ...
    public SportsSummaryV3() {}

    public SportsSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
