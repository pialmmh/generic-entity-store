...
/**
 * MySQL Entity: TelecomAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomAccountV3 implements Serializable {
    ...
    public TelecomAccountV3() {}

    public TelecomAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
