...
/**
 * MySQL Entity: TelecomAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomAnalyticsV3 implements Serializable {
    private static final long serialVersionUID = 497L;
    ...
    public TelecomAnalyticsV3() {}

    public TelecomAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
