...
/**
 * MySQL Entity: TelecomArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomArchiveV3 implements Serializable {
    private static final long serialVersionUID = 485L;
    ...
    public TelecomArchiveV3() {}

    public TelecomArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
