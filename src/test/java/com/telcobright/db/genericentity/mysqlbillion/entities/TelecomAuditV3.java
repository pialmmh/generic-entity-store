...
/**
 * MySQL Entity: TelecomAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomAuditV3 implements Serializable {
    private static final long serialVersionUID = 488L;
    ...
    public TelecomAuditV3() {}

    public TelecomAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
