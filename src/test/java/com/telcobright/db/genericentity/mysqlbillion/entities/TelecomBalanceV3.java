...
/**
 * MySQL Entity: TelecomBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomBalanceV3 implements Serializable {
    ...
    public TelecomBalanceV3() {}

    public TelecomBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
