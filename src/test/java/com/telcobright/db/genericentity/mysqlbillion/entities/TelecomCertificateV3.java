...
/**
 * MySQL Entity: TelecomCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomCertificateV3 implements Serializable {
    ...
    public TelecomCertificateV3() {}

    public TelecomCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
