...
/**
 * MySQL Entity: TelecomDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomDetailV3 implements Serializable {
    ...
    public TelecomDetailV3() {}

    public TelecomDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
