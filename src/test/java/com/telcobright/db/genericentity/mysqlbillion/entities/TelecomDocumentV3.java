...
/**
 * MySQL Entity: TelecomDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomDocumentV3 implements Serializable {
    ...
    public TelecomDocumentV3() {}

    public TelecomDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
