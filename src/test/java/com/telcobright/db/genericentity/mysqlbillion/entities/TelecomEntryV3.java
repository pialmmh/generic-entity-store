...
/**
 * MySQL Entity: TelecomEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomEntryV3 implements Serializable {
    ...
    public TelecomEntryV3() {}

    public TelecomEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
