...
/**
 * MySQL Entity: TelecomHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomHistoryV3 implements Serializable {
    ...
    public TelecomHistoryV3() {}

    public TelecomHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
