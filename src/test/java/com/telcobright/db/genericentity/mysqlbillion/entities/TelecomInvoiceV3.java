...
/**
 * MySQL Entity: TelecomInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomInvoiceV3 implements Serializable {
    ...
    public TelecomInvoiceV3() {}

    public TelecomInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
