...
/**
 * MySQL Entity: TelecomMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomMetricV3 implements Serializable {
    ...
    public TelecomMetricV3() {}

    public TelecomMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
