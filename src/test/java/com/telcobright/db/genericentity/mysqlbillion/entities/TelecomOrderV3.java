...
/**
 * MySQL Entity: TelecomOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomOrderV3 implements Serializable {
    ...
    public TelecomOrderV3() {}

    public TelecomOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
