...
/**
 * MySQL Entity: TelecomPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomPaymentV3 implements Serializable {
    ...
    public TelecomPaymentV3() {}

    public TelecomPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
