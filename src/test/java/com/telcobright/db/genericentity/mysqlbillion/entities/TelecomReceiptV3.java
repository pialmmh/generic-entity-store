...
/**
 * MySQL Entity: TelecomReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomReceiptV3 implements Serializable {
    ...
    public TelecomReceiptV3() {}

    public TelecomReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
