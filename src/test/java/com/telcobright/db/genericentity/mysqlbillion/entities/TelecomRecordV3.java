...
/**
 * MySQL Entity: TelecomRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomRecordV3 implements Serializable {
    ...
    public TelecomRecordV3() {}

    public TelecomRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
