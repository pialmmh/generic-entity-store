...
/**
 * MySQL Entity: TelecomReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomReportV3 implements Serializable {
    ...
    public TelecomReportV3() {}

    public TelecomReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
