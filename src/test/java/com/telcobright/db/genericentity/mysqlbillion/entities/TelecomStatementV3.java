...
/**
 * MySQL Entity: TelecomStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomStatementV3 implements Serializable {
    ...
    public TelecomStatementV3() {}

    public TelecomStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
