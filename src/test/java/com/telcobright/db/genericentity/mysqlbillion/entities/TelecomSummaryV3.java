...
/**
 * MySQL Entity: TelecomSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TelecomSummaryV3 implements Serializable {
    private static final long serialVersionUID = 479L;
    ...
    public TelecomSummaryV3() {}

    public TelecomSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
