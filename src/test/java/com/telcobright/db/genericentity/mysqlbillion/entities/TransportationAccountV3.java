...
/**
 * MySQL Entity: TransportationAccountV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationAccountV3 implements Serializable {
    private static final long serialVersionUID = 965L;
    ...
    public TransportationAccountV3() {}

    public TransportationAccountV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
