...
/**
 * MySQL Entity: TransportationAnalyticsV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationAnalyticsV3 implements Serializable {
    ...
    public TransportationAnalyticsV3() {}

    public TransportationAnalyticsV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
