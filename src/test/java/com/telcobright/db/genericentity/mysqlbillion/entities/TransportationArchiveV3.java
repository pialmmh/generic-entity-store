...
/**
 * MySQL Entity: TransportationArchiveV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationArchiveV3 implements Serializable {
    private static final long serialVersionUID = 947L;
    ...
    public TransportationArchiveV3() {}

    public TransportationArchiveV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
