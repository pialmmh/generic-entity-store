...
/**
 * MySQL Entity: TransportationAuditV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationAuditV3 implements Serializable {
    private static final long serialVersionUID = 950L;
    ...
    public TransportationAuditV3() {}

    public TransportationAuditV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
