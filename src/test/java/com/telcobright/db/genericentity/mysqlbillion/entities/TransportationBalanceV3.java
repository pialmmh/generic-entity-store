...
/**
 * MySQL Entity: TransportationBalanceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationBalanceV3 implements Serializable {
    ...
    public TransportationBalanceV3() {}

    public TransportationBalanceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
