...
/**
 * MySQL Entity: TransportationCertificateV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationCertificateV3 implements Serializable {
    ...
    public TransportationCertificateV3() {}

    public TransportationCertificateV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
