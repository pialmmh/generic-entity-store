...
/**
 * MySQL Entity: TransportationDetailV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationDetailV3 implements Serializable {
    private static final long serialVersionUID = 938L;
    ...
    public TransportationDetailV3() {}

    public TransportationDetailV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
