...
/**
 * MySQL Entity: TransportationDocumentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationDocumentV3 implements Serializable {
    private static final long serialVersionUID = 968L;
    ...
    public TransportationDocumentV3() {}

    public TransportationDocumentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
