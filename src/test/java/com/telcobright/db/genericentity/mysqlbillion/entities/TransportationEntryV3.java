...
/**
 * MySQL Entity: TransportationEntryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationEntryV3 implements Serializable {
    ...
    public TransportationEntryV3() {}

    public TransportationEntryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
