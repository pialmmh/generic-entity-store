...
/**
 * MySQL Entity: TransportationHistoryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationHistoryV3 implements Serializable {
    private static final long serialVersionUID = 944L;
    ...
    public TransportationHistoryV3() {}

    public TransportationHistoryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
