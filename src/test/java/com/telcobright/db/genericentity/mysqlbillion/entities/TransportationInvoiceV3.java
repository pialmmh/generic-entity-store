...
/**
 * MySQL Entity: TransportationInvoiceV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationInvoiceV3 implements Serializable {
    ...
    public TransportationInvoiceV3() {}

    public TransportationInvoiceV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
