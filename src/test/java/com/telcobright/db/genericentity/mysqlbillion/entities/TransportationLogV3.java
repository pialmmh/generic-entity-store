...
/**
 * MySQL Entity: TransportationLogV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationLogV3 implements Serializable {
    ...
    public TransportationLogV3() {}

    public TransportationLogV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
