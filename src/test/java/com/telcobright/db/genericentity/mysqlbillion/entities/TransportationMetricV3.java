...
/**
 * MySQL Entity: TransportationMetricV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationMetricV3 implements Serializable {
    ...
    public TransportationMetricV3() {}

    public TransportationMetricV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
