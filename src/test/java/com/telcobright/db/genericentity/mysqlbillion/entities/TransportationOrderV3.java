...
/**
 * MySQL Entity: TransportationOrderV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationOrderV3 implements Serializable {
    private static final long serialVersionUID = 977L;
    ...
    public TransportationOrderV3() {}

    public TransportationOrderV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
