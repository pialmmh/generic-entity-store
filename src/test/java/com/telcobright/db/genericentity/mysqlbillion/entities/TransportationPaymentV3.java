...
/**
 * MySQL Entity: TransportationPaymentV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationPaymentV3 implements Serializable {
    ...
    public TransportationPaymentV3() {}

    public TransportationPaymentV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
