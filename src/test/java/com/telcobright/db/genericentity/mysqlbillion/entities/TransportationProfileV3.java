...
/**
 * MySQL Entity: TransportationProfileV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationProfileV3 implements Serializable {
    private static final long serialVersionUID = 962L;
    ...
    public TransportationProfileV3() {}

    public TransportationProfileV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
