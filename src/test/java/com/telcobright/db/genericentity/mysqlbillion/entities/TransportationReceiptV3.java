...
/**
 * MySQL Entity: TransportationReceiptV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationReceiptV3 implements Serializable {
    ...
    public TransportationReceiptV3() {}

    public TransportationReceiptV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
