...
/**
 * MySQL Entity: TransportationRecordV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationRecordV3 implements Serializable {
    private static final long serialVersionUID = 929L;
    ...
    public TransportationRecordV3() {}

    public TransportationRecordV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
