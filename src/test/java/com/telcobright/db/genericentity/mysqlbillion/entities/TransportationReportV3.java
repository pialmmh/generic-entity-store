...
/**
 * MySQL Entity: TransportationReportV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationReportV3 implements Serializable {
    ...
    public TransportationReportV3() {}

    public TransportationReportV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
