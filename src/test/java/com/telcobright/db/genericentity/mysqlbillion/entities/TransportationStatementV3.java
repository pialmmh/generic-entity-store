...
/**
 * MySQL Entity: TransportationStatementV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationStatementV3 implements Serializable {
    ...
    public TransportationStatementV3() {}

    public TransportationStatementV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
