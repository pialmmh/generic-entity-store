...
/**
 * MySQL Entity: TransportationSummaryV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationSummaryV3 implements Serializable {
    ...
    public TransportationSummaryV3() {}

    public TransportationSummaryV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
