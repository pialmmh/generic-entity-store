...
/**
 * MySQL Entity: TransportationTransactionV3
 * Variant 3 with specific MySQL data type combinations
 */
public class TransportationTransactionV3 implements Serializable {
    private static final long serialVersionUID = 926L;
    ...
    public TransportationTransactionV3() {}

    public TransportationTransactionV3(Long id, String code, String name) {
        this.id = id;
        this.code = code;
        this.name = name;
    }
